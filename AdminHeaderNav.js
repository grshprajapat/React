...
class AdminHeaderNav extends Component {
  ...
  */ 
  ...
  componentDidMount() {
	  ...
	  if(gid == 'allRoleBased' || gid == 'sellers' || gid == 'users')
	  {
			this.setState({
					showManagerList: true
				});
	  }
	   if(gid == 'brands' || gid == 'products'|| gid == 'addProduct' || gid == 'categories'|| gid == 'addCategory'|| gid == 'addbrand')
	  {
			this.setState({
  ...
  render() {
	...
	let catchec = false;
	 if(gid == 'categories' || gid == 'addCategory' )
	 {
	 catchec = true; 
	 }
	 let catbran = false;
	 if(gid == 'brands' || gid == 'addbrand' )
	 {
	 catbran = true; 
	 }
	 let catpro = false;
	 if(gid == 'products' || gid == 'addProduct' )
	 {
	 catpro = true; 
	 }
	 let catblog = false;
	 if(gid == 'blogs' || gid == 'create-new-blog' )
	 {
	 catblog = true; 
	 }
	 let catpages = false;
	 if(gid == 'pages' || gid == 'create-new-page' )
	 {
	 catpages = true; 
	 }
               ...
               with font-awesome or any other icon font library */}
				...
				{this.state.showProductMList && (
				 ...
				 <ul className='admin-nav-effect'>
				  <li className="nav-item">
                  <Link to={window.appUrl+"admin/categories"} className={"nav-link " + (catchec ==true ? 'active' : '')}>
				...
				<li className="nav-item">
                  <Link to={window.appUrl+"admin/brands"} className={"nav-link " + (catbran == true ? 'active' : '')}>
                ...
                <li className="nav-item" >
                  <Link to={window.appUrl+"admin/products"} className={"nav-link " + (catpro == true ? 'active' : '')}>
                  
				  
                    <i className="nav-icon fa fa-eercast text-white  mr-2" />
                    <p className="text-white">
                    Products
                    </p>
                  </Link>
				...
				<li className="nav-item">
                  <Link to={window.appUrl+"admin/blogs"} className={"nav-link " + (catblog ==true ? 'active' : '')}>
                 
                    <i className="nav-icon fa fa-newspaper-o text-white " />
				...
				<li className="nav-item">
                  <Link to={window.appUrl+"admin/pages"} className={"nav-link " + (catpages == true ? 'active' : '')}>
